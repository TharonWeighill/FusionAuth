...
// tag::clientIdSecret[]
const clientId = 'a7f398aa-8337-4112-94a0-f99bc29a8136';
const clientSecret = 'nTUHnlCcKvVnVhofP47ROBaWulWbK84N-l-xc3PzC2g';
// end::clientIdSecret[]
...
/* logout home page. */
router.get('http://localhost:3000/logout', function (req, res, next) {
    req.session.destroy();
    res.redirect(302, '/');
});

/* GET home page. */
router.get('http://localhost:9800/', function (req, res, next) {
...
router.get('http://localhost:9800/oauth-redirect', function (req, res, next) {
